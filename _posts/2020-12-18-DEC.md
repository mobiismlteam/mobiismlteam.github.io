...
<b>Side note:</b> { } in formula do not work as intended for Jekyll, we will use \[ \] to represent collections : less confusing to use square brackets which are more rarely used than ( ).

<h3>Software workflow and network structure</h3>

<br />
<img src="dec_networkstruct.png" >
<br />
<img src="dec_softwarewf.png" width="600">
<br />
...
<img src="dec_autoencoder_decoder.png" >
