...
Given P(i|v) (\*3.4) from NCEAverage, and indexes (targets) of a batch of data, calculate the objective function (\*EX1)
...
This formula will appear a lot in this code.
...
\*5.2. $w_{c} = \sum_{i\in N_{k}}{{\alpha}_{i}\cdot 1(c_{i}=c)}$
